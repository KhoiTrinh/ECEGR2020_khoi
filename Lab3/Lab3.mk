...
ProjectPath            :=C:/Users/trinh/OneDrive/Documents/CodeLite/ECEGR2020/Lab3
...
../build-$(ConfigurationName)/Lab3/main.c$(ObjectSuffix): main.c ../build-$(ConfigurationName)/Lab3/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/trinh/OneDrive/Documents/CodeLite/ECEGR2020/Lab3/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
